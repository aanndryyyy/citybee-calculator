...
<svelte:head>
  ...
  <script defer data-domain="aanndryyyy.github.io/citybee-calculator" src="https://plausible.io/js/script.js"></script>
</svelte:head>
...
<main class="max-w-2xl mx-auto px-4 lg:px-0 my-4 lg:my-24">
  ...
  <label class="block mb-4">
    ...
    <input class="w-full h-2 bg-orange-600 rounded-lg appearance-none cursor-pointer" type=range bind:value={totalMinutes} min=0 max=4320>
  </label>
  ...
  <label class="block mb-8">
    ...
    <input class="w-full h-2 bg-orange-600 rounded-lg appearance-none cursor-pointer" type=range bind:value={totalKilometres} min=0 max=360>
  </label>
